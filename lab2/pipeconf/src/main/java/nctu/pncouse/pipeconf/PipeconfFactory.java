...
public final class PipeconfFactory {
    ...
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/learning_bridge_p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/learning_bridge.json");
